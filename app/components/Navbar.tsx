...
export default function Navbar() {
  ...
  return (
    <div className="sticky z-[600] px-[1.5%] bg-white  m-auto    top-0">
      <nav
        className={
          ...
          >
            <ul className="font-normal items-center flex flex-col p-3 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0  dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                  ...
                  <li key={link.name} className="">
                    <Link href={link.href}>
                      <div
                        ...
                        font-light ${
                          path === link.href && "underline text-red-600"
                        } rounded hover:bg-gray-100  md:hover:bg-transparent md:border-0 md:pt-1 pt-1 md:hover:text-red-600   md:p-0 `}
                      >
                        {link.name}
                      </div>
                    </Link>
              ...
              {!isAuthenticated && !isLoading && (
                <LoginLink className="text-white shadow-md rounded-md bg-red-600 hover:bg-red-700 font-medium  text-sm px-5 py-2.5 focus:outline-none dark:bg-red-600 dark:hover:bg-red-700 focus:ring-2 focus:ring-red-600 self-center transition-all duration-300">
                  Sign in
                </LoginLink>
              )}
