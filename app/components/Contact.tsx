...
function Contact2() {
    return (
        <div className="w-[90%] mx-auto pt-16">
            ...
            <div className="flex">
                <div className="xl:w-2/5 lg:w-2/5 bg-red-600 rounded-md py-16 ">
                ...
                <div className="xl:w-3/5 lg:w-3/5 bg-gray-100 h-full pt-5 pb-5 xl:pr-0 xl:pl-0 rounded-tr rounded-br">
                    <form id="contact" className="bg-white py-4 px-8 rounded-tr rounded-br">
                        ...
                        <div className="w-full mt-6">
                            ...
                            <button type="submit" className="focus:outline-none bg-red-600 transition duration-150 ease-in-out hover:bg-red-700 rounded text-white px-8 py-3 text-sm leading-6">
                                Submit
                            </button>
                        </div>
                    </form>
