  ...
  return (
    agent && (
      <div className="flex-col absolute z-[100] inset-0 m-auto text-left bg-black bg-opacity-[40%] pt-[10rem] w-screen h-screen">
        <div className="flex bg-white border w-[70%] h-[70%] rounded-[1rem]  overflow-scroll m-auto">
          <div className="    pb-2 items-center sticky top-0  bg-white  mx-auto pt-[10%]">
          ...
          <div className=" bg-gray-50   w-[70%] h-[screen]  px-[10%] m-auto pt-10 ">
            <p >{agent.bio}</p>
          </div>
        </div>
      </div>
